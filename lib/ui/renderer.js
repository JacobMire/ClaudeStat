    ...
    <div class="card ${anim2}" style="margin-top: 16px; background: var(--bg-surface-elevated);">
      <div class="card-header">
        <div class="card-title" style="display: flex; align-items: center; gap: 6px;">
          ...
          <span title="Projections are approximate estimates based on your recent usage burn rate and limited data points." style="cursor: help; display: flex; align-items: center;">
