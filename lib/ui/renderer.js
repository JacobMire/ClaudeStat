    ...
    <div class="card ${anim2}" style="margin-top: 16px; background: var(--bg-surface-elevated);">
      <div class="card-header">
        <div class="card-title" style="display: flex; align-items: center; gap: 6px;">
          ...
          <svg title="Projections are approximate estimates based on your recent usage burn rate and limited data points." width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: var(--text-secondary); cursor: help;">
