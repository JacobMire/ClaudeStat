...
<p align="center">
  <img src="assets/showcase_v2.jpg" width="600" alt="ClaudeStat Demo">
</p>
...
- **Dual Limits Tracking:** Explicitly tracks both your **5-Hour Session Limit** and your **7-Day Weekly Limit**, complete with an elegant, Apple-style day tracker to visualize exactly where you are in your weekly cycle.
...
- **Analytics Engine (`lib/utils/analyticsEngine.js`):** Parses raw usage timeseries data to calculate session deltas and dynamic burn rates.
...
- **Smart Caching (`lib/storage/`):** Implements a stale-while-revalidate cache with built-in schema migration validation to prevent `NaN%` errors if the data structure changes.
